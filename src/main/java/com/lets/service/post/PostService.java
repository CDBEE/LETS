...
public class PostService {
    ...
    public PostCommentResponseDto findPost(User user, Long postId){
        ...
        String profile = cloudinaryUtil.findFileURL(post.getUser().getPublicId());
        ...
        List<PostTechStack> postTechStackList = postTechStackRepository.findAllByPosts(Arrays.asList(post));
        List<Tag> tags = new ArrayList<>();
