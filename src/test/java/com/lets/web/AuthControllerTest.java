...
public class AuthControllerTest {
    ...
    @Test
    void access_token_재발급_refresh_token_존재X() throws Exception{
        //given
        String url = "http://localhost:" + port + "/api/auth/silent-refresh";
    ...
    @Test
    void access_token_재발급_탈퇴_후_요청() throws Exception{
        //given
    ...
    @Test
    void access_token_재발급_refresh_token_유효하지X() throws Exception{
        //given
    ...
    @Test
    void 회원가입_중복_가입() throws Exception{
        //given
    ...
    @Test
    void 회원가입_성공_기본_프로필() throws Exception{
        //given
    ...
    @Test
    void 로그아웃_refresh_token_없음() throws Exception{
        //given
    ...
    @Test
    void 탈퇴_refresh_token_없음() throws Exception{
        //given
    ...
    @Test
    void 탈퇴_성공_기본이미지() throws Exception{
        //given
        String url = "http://localhost:" + port + "/api/auth/signout";
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization",  accessToken);
